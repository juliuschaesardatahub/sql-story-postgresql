...
-- Columns updated based on provided header
...
-- Import data for Periode from mounted volume
COPY periode (
    date_actual,
    date_actual_time,
    day_suffix,
...
-- Table structure for Superstore
...
-- Set datestyle to match CSV format (MM/DD/YYYY)
SET datestyle = 'MDY';

-- Import data for Superstore from mounted volume
COPY superstore (
    row_id,
    order_id,
    order_date,
